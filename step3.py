...
# with command line options: step3 --conditions auto:phase1_2018_realistic --pileup_input das:/RelValMinBias_13/CMSSW_10_5_0_pre1-103X_upgrade2018_realistic_v8-v1/GEN-SIM -n 10 --era Run2_2018 --eventcontent RECOSIM,MINIAODSIM,DQM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,RECOSIM,EI,PAT,VALIDATION:@standardValidation+@miniAODValidation,DQM:@standardDQM+@ExtraHLT+@miniAODDQM --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO --pileup AVE_50_BX_25ns --geometry DB:Extended --io RecoFullPU_2018PU.io --python RecoFullPU_2018PU.py --no_exec --filein file:step2.root --fileout file:step3.root --nThreads 4
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
			'file:step2.root'
		#'file:root://cmsxrootd-site.fnal.gov//store/relval/CMSSW_10_5_0_pre2/RelValZMM_13/GEN-SIM-DIGI-RAW/PU25ns_105X_upgrade2018_realistic_v2-v1/10000/FA0DBD39-2DF8-3540-8B6C-8B9BB9B3B17D.root'
		),
